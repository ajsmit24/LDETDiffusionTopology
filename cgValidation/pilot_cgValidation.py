...
output_files={}
batch_output_file_format="{jobname}_d{dim}_b{batch}.out"
...
def run_job(job_name,highest_dimension,calcs_per_batch,peroidic_unit_size,write_freq=25,useMPI=True):
    global output_files
    job_options={
